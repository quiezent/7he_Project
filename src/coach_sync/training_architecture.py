    ...
    return {
        ...
        "integrated_coaching_model": {
            ...
            "same_day_environment_context": {
                ...
                "persistence_boundary": {
                    "included": "Bounded normalized selected fields, latest-attempt status and last-known-good evidence in snapshots/environment_evidence.json and its dated counterpart.",
                    "excluded": "Raw endpoint response, server history series, legacy local endpoint data, dashboard scrapes and IQAir fallback data.",
                },
            },
        ...
        "session_contract": {
            ...
            "stop_rules": [
                ...
                "Stop or move indoors when current environmental conditions or symptoms make the planned outdoor exposure inappropriate.",
